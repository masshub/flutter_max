...
import 'package:flutter_max/widget/SlideView.dart';
import 'package:flutter_max/widget/SlideViewIndicator.dart';
  ...
  Widget renderRow(i) {
        ...
        new Expanded(
          ...
          child: new Row(
            ...
            children: <Widget>[
              ...
              new Image.asset('assets/images/ic_comment.png', width: 16.0, height: 16.0),
            ],
          ),
        )
      ],
    ...
    var thumbImg = new Container(
      ...
      decoration: new BoxDecoration(
        ...
        color: const Color(0xFFECECEC),
        image: new DecorationImage(
            image: new ExactAssetImage('assets/images/ic_img_default.jpg'),
            fit: BoxFit.cover),
        border: new Border.all(
          color: const Color(0xFFECECEC),
          width: 2.0,
    ...
    return new InkWell(
      child: row,
      onTap: () {
        CommonUtils.lannchWebView(context, itemData['detailUrl'], 'test');
